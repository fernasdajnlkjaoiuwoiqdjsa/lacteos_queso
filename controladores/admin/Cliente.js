...
const SAVE_FORM = document.getElementById('saveForm'),
    ...
    TELEFONO_CLIENTE = document.getElementById('telefonoClinte'),
    RELACION_CLIENTE = document.getElementById('relacionClinte'),
    FECHA_REGISTRO = document.getElementById('registroCliente');
