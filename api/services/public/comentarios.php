...
<body>
            ...
            <div class="container-fluid">
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto">
                              <li class="nav-item">
                                    <a class="nav-link" aria-current="page" href="../../views/publico/inicio.html"><i class="bi bi-house-door">Inicio</i>
                                    </a>
                              </li>
                              <li class="nav-item">
                                    <a class="nav-link" aria-current="page" href="views/publico/index.html"><i class="bi bi-people-fill">Catalogo de Productos</i></a>
                              </li>
                              <li class="nav-item">
                                    <a class="nav-link" aria-current="page" href="views/publico/nosotros.html"><i class="bi bi-people-fill">Acerca de
                                                Nosotros</i></a>
                              </li>
                              <li class="nav-item">
                                    <a class="nav-link" aria-current="page" href="views/publico/carrito.html"><i class="bi bi-people-fill">Carrito</i></a>
                              </li>
                              <li class="nav-item">
      ...
      <div class="container">
            <h3 class="mt-5">
                  <center>Comentarios de Clientes</center>
            </h3>
            <hr>
            <div class="row">
      ...
      <footer>
            <div class="footer-content">
                  ...
                  <p>Este año empezamos con la distrubucion de los mejores lacteos en toda ciudad ya que son productos
                        ...
                        natural</p>
                  <ul class="socials">
                        <li><a href="https://www.facebook.com/profile.php?id=61557180795985&mibextid=ZbWKwL"><i class="bi bi-facebook"></i></a></li>
